 ...
 */
import { getClock, clockIn, clockOut, breakStart, breakEnd, getIncomingPassdown } from './clock';
...
export default (app) => {
  ...
  app.get('/tenant/:tenantId/supervisor/me/passdown/incoming', getIncomingPassdown);
