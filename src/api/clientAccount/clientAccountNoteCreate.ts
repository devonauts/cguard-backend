/** @openapi { "summary": "Create a note for a client account", "requestBody": { "content": { "application/json": { "schema": { "type": "object", "properties": { "title": { "type": "string" }, "description": { "type": "string" }, "noteDate": { "type": "string", "format": "date-time" }, "attachment": { "type": "array", "items": { "type": "object", "properties": { "name": { "type": "string" }, "mimeType": { "type": "string" }, "sizeInBytes": { "type": "integer" }, "storageId": { "type": "string" }, "privateUrl": { "type": "string" }, "publicUrl": { "type": "string" } } } } }, "required": ["title"] } } } }, "responses": { "200": { "description": "Note created with payload" }, "400": { "description": "Validation error" } } } */
...
export default async (req, res, next) => {
  try {
    ...
    const data = req.body || {};
    data.notableType = 'clientAccount';
    data.notableId = clientAccountId;
