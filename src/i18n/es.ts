const es = {
  ...
  auth: {
    ...
    mustUseCustomerApp: 'Esta cuenta es de cliente. Por favor usa la app de clientes para iniciar sesión.',
    channelNotAllowed: 'Esta cuenta no puede iniciar sesión desde esta aplicación.',
  ...
  clientAccount: {
    errors: {
      ...
      exists: 'Ya existe un cliente con este correo electrónico.'
    },
      validation: {
        invalidRuc: 'RUC inválido (debe ser 13 dígitos y terminar en 001).',
