...
export const EVENT_TO_ROW: Record<string, string> = {
  ...
  'attendance.geofence_exit': 'geofence-alert',
  'attendance.geofence_return': 'geofence-alert',
  'guard.inactive': 'inactive-guard-alert',
  'guard.license_expiring': 'license-expiry',
  ...
  'attendance.approval_required': 'attendance-approvals',
  'attendance.approved': 'attendance-approvals',
  'attendance.rejected': 'attendance-approvals',
